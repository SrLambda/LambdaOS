...
- **OS:** Arch Linux
- **Sistema de Archivos:** BTRFS (ideal para configurar _snapshots_ automatizados y evitar rupturas del sistema).
...
- **TUI Configuración Neovim:** Wraper de configuraciones de NeoVim integrado con Qtile